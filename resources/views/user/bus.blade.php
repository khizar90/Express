                                ...
                                @foreach ($buses as $bus)
                                    <tr class="odd">
                                        ...
                                        <td class="" style="">
                                            ...
                                            <div class="modal fade" data-bs-backdrop='static' id="deleteModal{{ $bus->id }}" tabindex="-1"
                                                aria-hidden="true">
                                            ...
                                            <div class="modal fade" data-bs-backdrop='static' id="editBus{{ $bus->id }}" tabindex="-1"
                                                aria-hidden="true">
                        ...
                        <div class="modal fade" data-bs-backdrop='static' id="addNewBus" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form id="addBusForm" action="{{ route('dashboard-add-bus') }}" method="POST">
                                        @csrf
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col mb-3">
                                                    <label for="nameWithTitle" class="form-label">Bus Name</label>
                                                    <input type="text" id="nameWithTitle" name="name"
                                                        class="form-control" placeholder="Add Bus" required />
                                                    <span class="text-danger mt-1">
                                                        @error('name')
                                                            {{ $message }}
                                                        @enderror
